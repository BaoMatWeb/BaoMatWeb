											...
											<div class="svdsDeTai" style="background:white;height:500px;margin-right:15px;border-radius:3px">
												...
												<div class="sv_table_dsDeTai">
													<table class="table table-striped table-hover" id="DSDeTai_SV">
														...
														<tbody>
														<%
				     										for (DeTai dtai: dt.getListDeTaiByMaCN(session.getAttribute("Email").toString())) {
				     											
														%>
															<tr>
																<td><%=dtai.getMaDT() %></td>
																<td><%=dtai.getTenDT() %></td>
																<td><%=dtai.getNgayThucHien() %></td>
																<td><%=dtai.getNgayKetThuc()%></td>
																<td class="trangthaiDT"><%=dtai.getTenTT()%></td>
																<td><a href="sinhvien_XemCTDT.jsp?MaDT=<%=dtai.getMaDT()%>">Xem</a></td>
																<td><a href="sinhvien_NopBaoCao.jsp?MaDT=<%=dtai.getMaDT()%>">Nộp</a></td>
																<td class="dropdown"><a class="btn btn-default dsDeTai_actionButton" data-toggle="dropdown" href="#"> Action </a>
																<ul id="contextMenu" class="dropdown-menu" role="menu">
																<li><a tabindex="-1" href="sinhvien_GiaHanDT.jsp?MaDT=<%=dtai.getMaDT() %>" >Gia Hạn</a></li>
																<li><a tabindex="-1" href="sinhvien_LyDoHyGHDT.jsp?MaDT=<%=dtai.getMaDT() %>">Hủy</a></li>
																</ul>
																</td>
															</tr>
														<%
